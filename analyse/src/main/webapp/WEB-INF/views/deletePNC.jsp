...
<body>
	...
	<p>Suppression D'un Passif Non Courant</p> <br><br></div>
	
	<div id="conteneur">
		<div id="menu">
		<form action="deleteData3" method="post">
    
    <table>
    <tr>
    <td> Id Passif Non Courant </td> <td> <input type="text" name="idPNC"> </td><td> </td>
    </tr>
    <tr>
