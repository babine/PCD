...
<html>
<head>
	<title>Gestion Des Ratios</title>
</head>
<style>
body{
...
<p>Gestion Des Ratios</p>
</div>	<div id="conteneur">
		<div id="menu">
		
		<ul>
		<li><a href="http://localhost:8080/Finance/Liquidité" title="cliquer">Ratios de liquidité</a></li>
		<li><a href="http://localhost:8080/Finance/Solvabilité" title="cliquer">Ratios de solvabilité</a></li>
