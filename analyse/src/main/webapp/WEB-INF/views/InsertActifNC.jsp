...
<html>
<head>
	<title>Insertion Des Actifs Non Courants</title>
</head>
<style>
body{
...
<body>
	...
	<p>Insertion Des Actifs Non Courants</p> <br><br></div>
    ...
    <tr>
    <td> Immobilisations Incorporelles </td><td><input type="text" name="immobilisationIncorporelles" style=" background-color: #696969;
    color: white;height:40px;"></td><td> </td>
    </tr>
    
    <tr>
    <td> Immobilisations Corporelles </td> <td> <input type="text" name="immobilisationCorporelles" style=" background-color: #696969;
    color: white;height:40px;"> </td><td> </td>
    </tr>
    
    <tr>
    <td> Immobilisations Financieres </td><td> <input type="text" name="immobilisationFinancieres" style=" background-color: #696969;
    color: white;height:40px;"></td><td></td>
    </tr>
